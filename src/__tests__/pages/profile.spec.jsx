...
describe('profile page structure testing', () => {
  ...
  it('should have a link to the Done Recipes Page', () => {
    const history = createMemoryHistory();
    ...
    const logOutButton = screen.getByTestId('profile-done-btn');
    expect(logOutButton).toBeInTheDocument();
  ...
  it('should have a link to the Favorite Recipes Page', () => {
    const history = createMemoryHistory();
    ...
    const logOutButton = screen.getByTestId('profile-favorite-btn');
    expect(logOutButton).toBeInTheDocument();

    fireEvent.click(logOutButton);

    const { pathname } = history.location;
    const expectedPath = '/favorite-recipes';
